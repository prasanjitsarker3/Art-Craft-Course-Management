    ...
    return (
        <div className="overflow-hidden">
            ...
            <div className="grid md:grid-cols-3 gap-5 ">
                ...
                <div data-aos="fade-right" className="card w-96  cursor-pointer mx-auto bg-gradient-to-b from-teal-400 to-teal-600 overflow-hidden">
                ...
                <div data-aos="zoom-in" className="card w-96  cursor-pointer mx-auto bg-gradient-to-b from-teal-400 to-teal-600 overflow-hidden">
                    <figure className="px-7 pt-5">
                ...
                <div data-aos="fade-left" className="card w-96  cursor-pointer mx-auto bg-gradient-to-b from-teal-400 to-teal-600 overflow-hidden">
                    <figure className="px-7 pt-5">
